...
**다만 지마켓에서 점선이 붙은 "슈퍼딜" 캐러셀은 엄밀히는 광고가 아니라 그 쇼핑몰 자체 상품 영역이다.** 스텁이 "특가·무료배송·할인"만 보고 광고로 판단한 것으로, 문맥을 못 읽어서 생기는 전형적인 오탐이다. LLM으로 교체하면 개선될 지점이자, 스텁의 판정 품질을 그대로 믿으면 안 되는 이유다.
